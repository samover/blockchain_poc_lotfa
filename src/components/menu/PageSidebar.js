        ...
        <div id="page-sidebar" style={{height: '1797px'}}>
            <div className="scroll-sidebar" style={{height: '1797px'}}>
                ...
                NEW
                    ...
                    <li>
                        <a href="#" title="Elements" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Dashboard boxes" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Widgets" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Forms UI" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Advanced tables" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Charts" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Maps" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Pages" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Other Pages" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Mailbox" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Snippets" className="sf-with-ul">
                    ...
                    <li>
                        <a href="#" title="Helpers" className="sf-with-ul">
